...
$t = trim($_GET['transaction']);             
$query = "select * from reserved_room where transaction_id='$t'"; 
...
<form  name="frm_savereserved" method="post" action="save_reserved.php"  target="iframe_savereserved">
    <table class="tbreserve">
        ...
        <tr>
            ...
            <td>
                <?php
                    ...
                    {
                        case 'approved': echo "<span style='font-weight:bold;color:blue;'>ชำระเงินแล้ว</span>";
                            break;
                        case 'waiting' : echo "<span style='font-weight:bold;color:red;'>ยังไม่ชำระเงิน</span>";
                            break;
                        default:
                            break;
                    }
        ...
        if($arrbooking['status']=='waiting')
        {
         ?>
              <tr><td class="block_title">&nbsp;</td><td></td></tr>
              <tr><td class="block_title">ข้อมูลสำหรับการชำระเงิน</td><td></td></tr>
              <tr>
