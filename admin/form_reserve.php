                      ...
                      jQuery.ajax({
                                 ...
                                 success:function(data){ 
                                     ...
                                     { 
                                           var str = data.split("/");
                                           console.log(str);
                                           $("#title_content").html("<div style='font-weight: bold;'>บันทึกการจองเรียบร้อยแล้ว</div>");
                                           $("#title_content").append("<table class='tbreserve'>\n\
                                                           <tr><td>รหัสจอง</td>\n\
                                                           <td>"+str[1]+"</td></tr>\n\
                                                    </table>");
                                     }
...
<form  name="frm_savereserved" method="post" action="save_reserved.php"  target="iframe_savereserved">
    <table class="tbreserve">
        <tr>
            <th colspan="2">ข้อมูลสำหรับการจองห้องประชุม</th>
        </tr>
        <tr>
