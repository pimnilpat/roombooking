...
$query = mysql_query("select * from user where username ='{$_GET['value']}'");
$user = array();
...
<form name="frm_edituser" action="save_useredit.php" method="post" enctype="multipart/form-data" target="iframe_edituser">
    ...
    <button type="reset" name="bt_deluser" onclick="deluser('<?php echo $user['username']; ?>')"><img src="img/button_cancel.png" width="22" height="16"/>ลบ</button>
    </p>
</form>
