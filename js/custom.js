...
/*	  $('#p-bar1')
	  ...
	  $('#p-bar3')
	     .css({"width":"25.07%"});
          ...
          $('#p-bar4').css({"width":"19.78%"});
          $('#p-bar5').css({"width":"7.43%"});
          $('#p-bar6').css({"width":"9.66%"});
...
$(document).ready(function()
{     
        $("#tb-research tr th:first-child").css({"width":"200"});
        $("#tb-research tr td:first-child").css({"width":"200"}); 
        $("#tb-research tr td:last-child").css({"width":"100"});
});

/*
$(document).ready(function()
{
      $("#tb-sla tr th").css({"background-color":"#6e8da7"});
      $("#tb-sla tr:odd td").css({"background-color":"#E8E8E8"});
      $("#tb-sla tr:even td").css({"background-color":"#fff"});
});
*/

$(document).ready(function(){    
    $("#div-summary-outer").hide();
    $("#notify_send_sup").hide();
});
...
$(document).ready(function()
{
    $("#reply_submit").click(function(){
        var reply = $("#text_reply").val();
                  ...
                  //$("#div-summary-outer").show(); 
                  $("#text_reply").attr("disabled","disabled");
                  $("#send_sup").attr("disabled","disabled");
                  $("#reply_submit").attr("disabled","disabled");
                  $("#send_sup").removeClass("common-button");
                  $("#reply_submit").removeClass("common-button"); 
                  $("#reply_submit").addClass("common-button-disable");
                  $('#areply').css("cursor","auto");                 
                          
    });
    
    $("#rddefหมายเหตุ").click(function(){
        $("#rdcusหมายเหตุ").attr("checked",false);
        $("#rddefหมายเหตุ").attr("checked",true);
        
        $("#customหมายเหตุ").attr("disabled","disabled");
        $("#defaultหมายเหตุ").removeAttr("disabled");
    });
    $("#rdcusหมายเหตุ").click(function(){
        $("#rdcusหมายเหตุ").attr("checked",true);
        $("#rddefหมายเหตุ").attr("checked",false);
        
        $("#customหมายเหตุ").removeAttr("disabled");
        $("#defaultหมายเหตุ").attr("disabled","disabled");
    });
...
function sendtosup(id,userid)
{
          ...
          else
          {
                      $.ajax({
                      type: "GET",
                      url: "supervisor_preview.php",
                      data: "pid=" + id +"&userid="+user_id +"&reply="+reply,
                      success: function(msg){
                                 //alert( "Data Saved: " + msg );
                                 $("#notify_send_sup").show(); 
                        }
                 });
...
$(document).ready(function()
{
    $("input[name='rd_report']").change(function(){
